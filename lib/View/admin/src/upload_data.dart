...
class StudentDataUploadScreen extends StatelessWidget {
  ...
  Widget _buildCsvUploadTab(BuildContext context) {
    return Obx(() {
      return Stack(
        children: [
          Column(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            items:
                                controller.institutes.map((String institute) {
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          _showAddInstituteDialog(context);
                        },
                      ),
                    ],
                  ),
  ...
  Future<void> _showAddInstituteDialog(BuildContext context) async {
    ...
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            labelText: "Institute Name", // Label Text
            labelStyle: TextStyle(
              color:Colors.black.withOpacity(0.7),
            ),
            hintText: "Enter institute name", // Hint Text
            hintStyle: TextStyle(
            ...
            //     ? Colors.grey[200]
            //     : Colors.grey[700], // Background color based on brightness
            ...
            focusedBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(
                color: Theme.of(context).brightness == Brightness.light
                    ? Colors.blue
                    : Colors.green, // Change border color on focus
                width: 2,
              ),
            ),
            contentPadding: EdgeInsets.symmetric(
                vertical: 12, horizontal: 16), // Padding inside the text field
          ),
        ),
        actions: [
          TextButton(
          ...
          TextButton(
            onPressed: () async {
              String newInstitute = instituteController.text.trim();
              if (newInstitute.isNotEmpty) {
                controller.addInstitute(newInstitute);
