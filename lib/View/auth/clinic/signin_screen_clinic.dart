...
import 'package:new_dental/View/auth/clinic/signup_screen_clinic.dart';
...
class SigninScreenClinic extends StatelessWidget {
  final AuthController authController = Get.put(AuthController());

  SigninScreenClinic({super.key});
